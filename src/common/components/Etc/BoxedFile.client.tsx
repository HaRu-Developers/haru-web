...
const BoxedFile = ({
  ...
  const iconClass = 'absolute top-[13px] left-[14px] h-6 w-6';

  return (
    <div className="h-[191px] w-[244px] shrink-0 rounded-2xl bg-gray-700 px-5 py-[17px]">
      ...
      <div className="shadow-boxed-file relative h-[108px] w-full shrink-0 rounded-[10px] bg-white">
        ...
        {thumbnailUrl ? (
          <img
            src={thumbnailUrl}
            alt=""
            className="h-full w-full rounded-[10px] object-cover object-top pt-10"
          />
        ) : (
          <div className="flex flex-col gap-1 px-3.5 pt-[47px] pb-[13px]">
