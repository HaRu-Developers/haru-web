...
import CreateSnsEventAssistentIcon from '@svgs/cta/CreateSnsEventAssistentIcon.svg';
...
const CtaIcons = ({ state, className }: IconsCommonProps<CtaIconsState>) => {
  switch (state) {
    ...
    case CtaIconsState.SNS_EVENT_ASSISTENT:
      return <CreateSnsEventAssistentIcon className={clsx('h-[97px] w-[132px]', className)} />;
